...
namespace HoloFab {
    ...
    public class GeneralUIMenu : MonoBehaviour {
        ...
        void Start() {
            ...
            buttonToggleGrid.onClick.AddListener(TurnOffpointsAndGrids);
            buttonObjects.onClick.AddListener(DestroyObjects);
        }
        //////////////////////////////////////////////////////////////////////////

...
namespace HoloFab {
	...
	public class TCPReceive {
		...
		public TCPReceive(int _localPort=11111){
			...
			this.debugMessages.Add("TCPReceive: Initiating.");
			TryStartConnection();
		}
		...
		private async void StartConnection(){
			...
			this.receiver = new Task(() => ReceiveData(), this.cancellationTokenSource.Token);
			this.receiver.Start();
		...
		private void ReceiveData(){
			try {
				...
				while (true) {
					if (this.client == null) {
						this.debugMessages.Add("TCPReceive: Listening for a Client!");
						...
						try {
							...
							if (this.stream.DataAvailable) {
								OnClientFound();
								this.debugMessages.Add("TCPReceive: Reading Data: " + this.client.Available.ToString());
								// this.status = "Reading Data: " + this.client.Available.ToString();
							} else {
								if (this.IsConnected) {
									this.debugMessages.Add("TCPReceive: No Data Available!");
